...
**NOTE:**  All code in GitHub in all repos and organizations is licensed [ATTRIBUTION-NONCOMMERCIAL-SHAREALIKE 4.0 INTERNATIONAL](https://creativecommons.org/licenses/by-nc-sa/4.0/) and this license supercedes any stated license in individual repos.  **Training AI models on source code is prohibited**.  Due to my ethical, security and leadership concerns about Microsoft, OpenAI, and Copilot I am migrating OFF GitHub to GitLab for Public, and will host most repos privately (shared in courses as zip files).  You can find new Public Repos on Codeberg:  [https://codeberg.org/noahgift](https://codeberg.org/noahgift)
